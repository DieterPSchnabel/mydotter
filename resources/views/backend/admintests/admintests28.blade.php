...
@section('title')
    <?php $this_filename ='admintests28'  ?>
    {{$this_filename}}
@endsection
@section('page-header')
    <h2>Settings</h2>
...
@section('content')
    ...
    $title3 = 'this template body options';
    ...
    $title4 = 'wichtiges script in coreui.io';
    $key4 = str_replace('/','_',$title4);
    $key4 = str_replace(' ','_',$key4);
    $key4 = substr('settings_'.$key4,0,50);
    $url4 = 'http://coreui.io/';
    $doc_url4 = 'http://coreui.io/demo/Ajax_Demo/js/app.js';
