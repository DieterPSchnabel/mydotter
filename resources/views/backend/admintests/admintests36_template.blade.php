...
$this_file_title = 'Settings & Konfiguration';
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:6px 6px 0 6px;border-top:1px #ccc solid;overflow:auto">
            ...
            {{--############################  row 1####################################################--}}
            <div class="card" id="" style="display:display">
    ...
    <a id="hide_all_cards_switch" style="margin-left:30px;display:none" class="btn btn-primary btn-sm float-right dimmed04" href="javascript:hide_all_cards();">
        <i class="fa fa-chevron-down fa-lg" aria-hidden="true"></i> hide all </a>
                    ...
                    <div class="tab-content" >
                            ...
                            {{--#########   Panel 1    #####################--}}
                            <div style="padding:1.2em" class="tab-pane active animated fadeIn" id="home4" role="tabpanel" aria-expanded="true">
                            ...
                            {{--#########   Panel 2    #####################--}}
                            <div style="padding:1.2em" class="tab-pane animated fadeIn" id="profile4" role="tabpanel" aria-expanded="false">
                            ...
                            {{--#########   Panel 3    #####################--}}
                            <div style="padding:1.2em" class="tab-pane animated fadeIn" id="messages4" role="tabpanel" aria-expanded="false">
                            ...
                            {{--#########   Panel 4    #####################--}}
                            <div style="padding:1.2em" class="tab-pane animated fadeIn" id="config4" role="tabpanel" aria-expanded="false">
...
<div style="height:800px"></div>
    ...
    <script>
        ...
        function show_all_cards(){
            $('#show_all_cards_switch').hide();
            $('#hide_all_cards_switch').show()
            for(i=1; i<=anz; i++){
                if($('#cont_settings_dashboard_' + i))  show('cont_settings_dashboard_' + i );
            }
        }
        function hide_all_cards(){
            $('#hide_all_cards_switch').hide();
            $('#show_all_cards_switch').show()
            for(i=1; i<=anz; i++){
