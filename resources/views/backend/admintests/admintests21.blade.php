...
@section('title')
    <?php $this_filename ='admintests21'  ?>
    {{$this_filename}}
@endsection
@section('page-header')
    <h2>Generators - How to</h2>
@endsection
...
@section('content')
    ...
    $title1 = 'spatie/laravel-html';
    $key1 = str_replace('/','_',$title1);
    $url1 = 'https://github.com/spatie/laravel-html';
    $doc_url1 = 'https://docs.spatie.be/laravel-html/v2/introduction';

    $title2 = 'marvinlabs/laravel-html-bootstrap-4 ';
    $key2 = str_replace('/','_',$title2);
    $url2 = 'https://github.com/marvinlabs/laravel-html-bootstrap-4';
    $doc_url2 = '';

    $title3 = 'laracasts/Laravel-5-Generators-Extended';
    $key3 = str_replace('/','_',$title3);
    $url3 = 'https://github.com/laracasts/Laravel-5-Generators-Extended';
    $doc_url3 = 'https://laracasts.com/lessons/faster-workflow-with-generators';

    $title4 = 'LaravelCollective/html';
    $key4 = str_replace('/','_',$title4);
    $url4 = 'https://github.com/LaravelCollective/html';
    $doc_url4 = 'https://laravelcollective.com/';

    $title5 = 'spatie/laravel-menu';
    $key5 = str_replace('/','_',$title5);
    $url5 = 'https://github.com/spatie/laravel-menu';
    $doc_url5 = 'https://murze.be/a-modern-package-to-generate-html-menus';

    $title6 = 'yajra/laravel-datatables-html';
    $key6 = str_replace('/','_',$title6);
    $url6 = '';
    $doc_url6 = '';

    $title7 = '	kristijanhusak/laravel-form-builder';
    $key7= str_replace('/','_',$title7);
    $url7 = 'https://github.com/kristijanhusak/laravel-form-builder';
    $doc_url7 = '';
