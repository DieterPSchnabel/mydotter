...
@section('title')
    <?php $this_filename = 'admintests33'  ?>
    All Notes DEV
@endsection
@section('page-header')
    <h2>All Notes DEV
...
@section('content')
    ...
    $title1 = 'Notes';
    $key1 = 'notes_superadmin';
    $url1 = link_to_route('admin.dashboard.admintests30','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url1 =  link_to_route_popup('dashboard/pop_dev_any_at?at=30','Popup')  ;

    $title2 = 'ToDo';
    $key2 = 'todo_superadmin';
    $url2 = link_to_route('admin.dashboard.admintests30','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url2 =  link_to_route_popup('dashboard/pop_dev_any_at?at=30','Popup')  ;

    $title3 = 'Nice to Have';
    $key3 = 'nice_to_have_superadmin';
    $url3 = link_to_route('admin.dashboard.admintests30','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url3 =  link_to_route_popup('dashboard/pop_dev_any_at?at=30','Popup')  ;

    $title4 = 'Keep an Eye on';
    $key4 = 'keep_an_eye_superadmin';
    ...
    $title5 = 'Settings - Notes';
    $key5 = 'settings_superadmin_notes';
    $url5 = link_to_route('admin.dashboard.admintests28','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url5 =  link_to_route_popup('dashboard/pop_dev_any_at?at=28','Popup')  ;

    $title6 = 'Settings - ToDo';
    $key6 = 'settings_superadmin_todo';
    $url6 = link_to_route('admin.dashboard.admintests28','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url6 =  link_to_route_popup('dashboard/pop_dev_any_at?at=28','Popup')  ;


    $title7 = 'Myhelpers-Notes';
    $key7 = 'myhelpers_superadmin_notes';
    $url7 = link_to_route('admin.dashboard.admintests29','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url7 =  link_to_route_popup('dashboard/pop_dev_any_at?at=29','Popup')  ;

    $title8 = 'Myhelpers-ToDo';
    $key8 = 'myhelpers_superadmin_todo';
    $url8 = link_to_route('admin.dashboard.admintests29','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url8 =  link_to_route_popup('dashboard/pop_dev_any_at?at=29','Popup')  ;

    $title9 = 'Translations - Notes';
    $key9 = 'translations_superadmin_notes';
    $url9 = link_to_route('admin.dashboard.admintests19','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url9 =  link_to_route_popup('dashboard/pop_dev_any_at?at=19','Popup')  ;

    $title10 = 'Translations - ToDo ';
    $key10 = 'translations_superadmin_todo';
    $url10 = link_to_route('admin.dashboard.admintests19','New Window',[],[ 'target="_blank"', 'class="btn btn-primary btn-sm float-right mr-10"']) ;
    $doc_url10 =  link_to_route_popup('dashboard/pop_dev_any_at?at=19','Popup')  ;
