...
@section('title')
    <?php $this_filename ='admintests25'  ?>
    {{$this_filename}}
@endsection
@section('page-header')
    <h2>to Javascript - How to</h2>
@endsection
...
@section('content')
    ...
    $title1 = 'spatie/laravel-blade-javascript';
    $key1 = str_replace('/','_',$title1);
    $url1 = 'https://github.com/spatie/laravel-blade-javascript';
    $doc_url1 = 'https://murze.be/a-blade-directive-to-export-php-variables-to-javascript';

    $title2 = 'laracasts/PHP-Vars-To-Js-Transformer';
    $key2 = str_replace('/','_',$title2);
    $url2 = 'https://github.com/laracasts/PHP-Vars-To-Js-Transformer';
    $doc_url2 = 'https://packagist.org/packages/laracasts/utilities';

    $title3 = 'jhoff/blade-vue-directive';
    $key3 = str_replace('/','_',$title3);
    $url3 = 'https://github.com/jhoff/blade-vue-directive';
    $doc_url3 = '';

    $title4 = 'ecrmnn/collect.js';
    $key4 = str_replace('/','_',$title4);
    $url4 = 'https://github.com/ecrmnn/collect.js';
    $doc_url4 = 'https://www.npmjs.com/package/collect.js';

    $title5 = 'keevitaja/linguist';
    $key5 = str_replace('/','_',$title5);
    $url5 = 'https://github.com/keevitaja/linguist';
    $doc_url5 = 'https://github.com/tightenco/ziggy';
