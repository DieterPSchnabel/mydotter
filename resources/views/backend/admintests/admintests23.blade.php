...
@section('title')
    <?php $this_filename ='admintests23'  ?>
    {{$this_filename}}
@endsection
@section('page-header')
    <h2>Auth/Permissions - How to</h2>
@endsection
...
@section('content')
    ...
    $title1 = 'spatie/laravel-permission';
    $key1 = str_replace('/','_',$title1);
    $url1 = 'https://github.com/spatie/laravel-permission';
    $doc_url1 = 'https://murze.be/a-package-to-add-roles-and-permissions-to-laravel';

    $title2 = 'laravel/socialite';
    $key2 = str_replace('/','_',$title2);
    $url2 = 'https://github.com/laravel/socialite';
    $doc_url2 = 'https://laravel.com/docs/5.5/socialite';

    $title3 = 'Laravel Reauthenticate';
    $key3 = str_replace('/','_',$title3);
    $url3 = 'https://medium.com/@browner12/laravel-reauthenticate-274c48f2b642';
    $doc_url3 = '';

    $title4 = 'arcanedev/no-captcha';
    $key4 = str_replace('/','_',$title4);
    $url4 = 'https://github.com/ARCANEDEV/noCAPTCHA';
    $doc_url4 = '';

    $title5 = 'anhskohbo/no-captcha';
    $key5 = str_replace('/','_',$title5);
    $url5 = 'https://github.com/anhskohbo/no-captcha';
    $doc_url5 = '';
