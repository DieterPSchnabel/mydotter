...
@section('content')
    ...
    <div style="padding:24px 90px 0 90px">{{--pagewrapper--}}
        <?php
        //$t_key = $_GET['key'];
        //$t_title = $_GET['title'];
        ...
        create_dv($t_key, $value = $t_title. ' - notes go here...',true, $field = 'div_res_long');
        ...
        <div style="margin:9px 0  9px 12px">
            ...
            <a style="margin-left:36px" class="btn btn-info" href="javascript:toggle('help_block_popup','slide')" role="button">
                <i class="icon-support"></i> Hilfe</a>
            <a style="margin-left:12px" class="btn btn-info ml-2" href="javascript:toggle('info_ck_editor','slide')" role="button">
