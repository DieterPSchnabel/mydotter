...
@section('page_level_styles')
    ...
    {{--<link href="{{ env('APP_URL') }}/my_plugins/editors/editor.css" rel="stylesheet" type="text/css"/>--}}
...
<div style="min-height:600px;margin:20px auto 6px auto;max-width:1300px;padding: 0 0 70px 0">
{!!
//dd($field);
...
!!}
    ...
    <div>
        <a style="margin:-60px 0 6px 12px" class="btn btn-info btn-sm" href="javascript:javascript:parent.location.reload()" role="button">
