    ...
    <div class="_card-body" style="background:#eee;padding:1.0em">
        ...
        <div class="tab-content">
            ...
            <div style="padding:1.2em"
                 class="tab-pane <?php if ($first_avtive_tab == 'hints') echo 'active'; ?> animated fadeIn" id="home3"
                 role="tabpanel"
                 aria-expanded="true">
            ...
            @if($table_has_help_help)
            <div style="padding:1.2em"
                 class="tab-pane <?php if ($first_avtive_tab == 'help') echo 'active'; ?> animated fadeIn" id="profile3"
                 role="tabpanel"
                 aria-expanded="false">
                2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
            ...
            @if($table_has_help_config)
            <div style="padding:1.2em"
                 class="tab-pane <?php if ($first_avtive_tab == 'config') echo 'active'; ?> animated fadeIn"
                ...
                <div class="card-deck">
                    ...
                    <div class="card config-card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><span style="color:#aaa">Seiten-Konfiguration für</span>
                            ...
                            <div style="margin:3px 0 8px 0;">
                                <small class="text-muted" style="display:inline-block;line-height:130%">Deaktivieren Sie
                                    'Tabelle filtern' wenn keine nützlichen Filter enthalten sind. Oder sprechen Sie mit
                                    dem Developer um gewünschte Filter einzubauen.
                                </small>
                            </div>
                            <div style="padding:4px 0;height:35px;padding-left:12px">
                                <?php
                            ...
                            <p>
                                <small style="display:inline-block;line-height:130%" class="text-muted">Beim Laden der
                                    Seite autom. sortieren nach sort_order?
                                    Falls deaktiviert erfolgt die Sortierung nach ID.
                                </small>
                            ...
                            <p>
                                <small style="display:inline-block;line-height:130%" class="text-muted">Bei
                                    Änderung der 'sort_order' automatisch einen Page-Reload machen?
                                </small>
                            ...
                            <p class="card-text">
                                <small style="display:inline-block;line-height:130%" class="text-muted">Einstellungen
                                    werden auf Klick sofort gespeichert und mit einem kleinem Haken rechts vom Schalter
                                    bestätigt.

                                    Nach einem Page-Reload (F5) sind nur die aktivierten Elemente auf der Seite
                                    sichtbar.
                                </small>
                            </p>
                        </div>
                    ...
                    <div class="card config-card">
                        {{--<img class="card-img-top" src="..." alt="Card image cap">--}}
                        <div class="card-body">
                            <h4 class="card-title"><span style="color:#aaa">DEV-Konfiguration für</span>
                                {{ucfirst($this_table_name)}}</h4>
