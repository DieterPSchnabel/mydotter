...
create_dv($this_table_name.'_disp_cols_arr', $sortables_str, 'div_res_long');
        ...
        @if($has_table_filter)
            <div class="btn-group" style="margin:0 30px 3px 0;margin-bottom:-15px;">
                <div class="dropdown">
                    ...
                    ?>
                    <div style="margin-top:37px" class="dropdown-menu animated slideInDown" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{!! route('admin.'.$this_table_name.'.index') !!}?filter=dummy">
                            dummy filter:<br>
                        zeige nur records mit id <= 30<br>
                        hier sinnvolle Filter einfügen</a>
