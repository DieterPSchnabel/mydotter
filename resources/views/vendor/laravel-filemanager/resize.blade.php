  ...
  <div class="col-md-4">
    ...
    <table class="table table-compact table-striped">
      ...
      <tbody>
        ...
        <tr>
          <td>
            {{--{{ trans('laravel-filemanager::lfm.resize-ratio') }}--}}
            @lang('lfm.resize-ratio')
          </td>
          <td>{{ number_format($ratio, 2) }}</td>
        </tr>
        <tr>
          <td>
            {{--{{ trans('laravel-filemanager::lfm.resize-scaled') }}--}}
            @lang('lfm.resize-scaled')
          </td>
          <td>
            {{--{{ trans('laravel-filemanager::lfm.resize-true') }}--}}
            @lang('lfm.resize-true')
          </td>
        </tr>
        @endif
        <tr>
          <td>
            {{--{{ trans('laravel-filemanager::lfm.resize-old-height') }}--}}
            @lang('lfm.resize-old-height')
          </td>
          <td>{{ $original_height }}px</td>
        </tr>
        <tr>
          <td>
            {{--{{ trans('laravel-filemanager::lfm.resize-old-width') }}--}}
            @lang('lfm.resize-old-width')
          </td>
          <td>{{ $original_width }}px</td>
        </tr>
        <tr>
          <td>{{--{{ trans('laravel-filemanager::lfm.resize-new-height') }}--}}
            @lang('lfm.resize-new-height')
          </td>
          <td><span id="height_display"></span></td>
        </tr>
        <tr>
          <td>{{--{{ trans('laravel-filemanager::lfm.resize-new-width') }}--}}
            @lang('lfm.resize-new-width')
          </td>
    ...
    <button class="btn btn-primary" onclick="doResize()">
