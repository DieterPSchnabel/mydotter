      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">
            ...
            @lang('lfm.title-upload')
          </h4><span style="color:#aaa">Du kannst auch mehrere Bilder gleichzeitig auf deinem Computer auswählen!</span>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="upload-btn">
            {{--{{ trans('laravel-filemanager::lfm.btn-upload') }}--}}
            @lang('lfm.btn-upload')
          </button>
        </div>
      </div>
