...
<div class="col-12">
	...
	<div class="card">
	    <div class="card-header h4">
	        <span class="">{{ trans('configmanager.title') }}</span>
	    </div>
	    <div class="card-block">
			<p class="float-right" style="margin-left:20px;"><a href="https://github.com/Krato/Laravel-5-Config-Manager" target="_blank">Krato/Laravel-5-Config-Manager</a>
			</p>
			<p class="float-right" style="font-weight:bold;color:#c00">Keys in Arrays are not displayed here! </p>
			...
			<label for="FormControlSelect2">{{ trans('configmanager.info_choose') }}</label>

	        <select class="form-control" id="FormControlSelect2" style="font-size:1.2em">
	...
	<div class="card">
	    <div class="card-header">
			...
			<div class="pull-left">
				<span style="font-weight:bold;font-size:1.2em" class="panel-title">{{ trans('configmanager.file') }}: {{ $fileData->name }}.php</span>
	        </div>
	        @if($fileData->parent)
	...
	<div id="content-edit" class="hide" style="max-width:250px;margin:0 auto 60px auto;">
...
@section('scripts')
	<script type="text/javascript">
		jQuery(document).ready(function(){
			...
			$('#FormControlSelect2').on('change', function(){
	            var file = $(this).val();
	            if (file) {
