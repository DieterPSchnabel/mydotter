...
class GTranslate
{
    ...
    private $api_key = 'AIzaSyBkMohG-its-omt2axTUurwlZQR3BUMFr8';
    //private $api_key = config('google.translation.api.key');
    ...
    private function requestCurl($url)
    {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false); /*Newly added*/
        ...
        switch ($this->api_version) {
            case "2":
                if (curl_getinfo($ch, CURLINFO_HTTP_CODE) == "200")
                    ...
                    throw new GTranslateException("Unable to perform Translation error http:" . curl_getinfo($ch, CURLINFO_HTTP_CODE));
                break;
